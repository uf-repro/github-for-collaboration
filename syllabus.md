...
* Inviting Collaborators
   ...
   * From the github repo page:
   ...
   ![A screenshot of the website https://github.com/ha0ye/portalDS/settings/access, showing that the repo is visible to the public, and that only the owner can contribute to the repository. There is a green button with the text 'Invite a collaborator'.](slides/github-manage-access.png)
...
* What happens if you forget to pull?
   ...
   ![A screenshot of the warning from using GitHub Desktop when trying to push new commits to GitHub, and there are commits on GitHub that have not yet been fetched and merged locally. The warning reads 'Newer Commits on Remote; Desktop is unable to push commits to this branch because there are commits on the remote that are not present on your local branch. Fetch these new commits before pushing in order to reconcile them with your local commits.'](slides/newer-commits-warning.png)
...
* Resolving merge conflicts
   ...
   * when git cannot combine the changes automatically, you must manually create the merged file:
   ![A screenshot of BBedit showing the merge conflict. Line 6 is '<<<<<<< HEAD'`' indicating the start of one version of the file. Line 8 is '=======' indicating the end of one version and the beginning of the next. Line 10 shows '>>>>>>>' followed by a hash, indicating the end of the second version.](slides/merge-conflict.png)
...
* Essentials of GitHub Flow
   ...
   ![A screenshot of the diagram from https://guides.github.com/introduction/flow/, showing conceptually how the 'GitHub flow' workflow works.](slides/github-flow.png)
...
* Creating new branches (GitHub)
   ...
   ![screenshot of the GitHub interface, when clicking on the pulldown menu to switch branches; this interface also enables one to create new branches.](slides/github-new-branch.png)
...
* Creating new branches (GitHub Desktop)
   ...
   ![screenshot of the GitHub Desktop interface, when clicking on the pulldown menu to switch branches; this interface also enables one to create new branches.](slides/github-desktop-new-branch.png)
